...
-- 51 AGENTS INSERT statements generated from agent-routing-catalog.md (excluded setup, flags, and plan agents)
-- Following the exact format from coordinator.backend example
-- Generated automatically with proper JSON formatting
INSERT OR IGNORE INTO agents_catalog (name, type, role, tech_stack, scenarios, tags, connections) VALUES 
...
('@analyst.strategic', 'analyst', 
 ...
 '["Requirements analysis", "roadmap planning", "stakeholder analysis", "competitive analysis", "market research tools", "OKR framework", "SWOT analysis", "Porter''s Five Forces", "Evidence BI platform", "modern 2025 strategic frameworks", "business model canvas", "technology assessment", "ROI analysis", "feasibility studies"]',
...
('@ops.troubleshooting', 'operations', 
