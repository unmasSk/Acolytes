---
command: tools
description: 🔧 View tool usage logs and statistics
---

# Tool Usage Analytics

View and analyze tool usage patterns from the current session or historical data.

## Usage

```bash
/tools           # Show recent tool usage (last 20)
/tools stats     # Show usage statistics
/tools session   # Show current session tools only
/tools blocked   # Show blocked tool attempts
/tools [name]    # Filter by specific tool name
```
...
```text
14:32:15 [SUCCESS] Read
  Category: file
  File: /src/app.js
  Result: Read 245 lines
  Data: 8.3 KB

14:31:02 [BLOCKED] Bash
  Category: execution
  Blocked: Dangerous rm command detected

14:30:45 [FAILED] Write
  Category: file
  File: /protected/config.env
  Error: Permission denied
```

---

_Command created for tool usage analytics in ClaudeSquad_