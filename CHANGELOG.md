...
- Strategic communication of project future direction to users and contributors through detailed roadmap documentation## [1.0.6] - 2025-01-28
...
- Modified **init**.py to derive version from importlib.metadata
...
- **7 Internal Agents**: System agents (setup._, flags._, plan.\*) for internal operations
...
- Fast file pattern matching with glob support (_.py, \*\*/_.js patterns) for 50x faster project analysis
